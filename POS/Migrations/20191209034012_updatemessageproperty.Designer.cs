...
namespace POS.Migrations
{
    ...
    [Migration("20191209034012_updatemessageproperty")]
    partial class updatemessageproperty
    {
            ...
            modelBuilder.Entity("POS.Models.Message", b =>
                {
                    ...
                    b.HasIndex("NotificationItemMethodId");
            ...
            modelBuilder.Entity("POS.Models.NotificationItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = 1,
                            CreatedDate = new DateTime(2019, 12, 9, 11, 40, 11, 887, DateTimeKind.Local).AddTicks(5829),
                            ModifiedDate = new DateTime(2019, 12, 9, 11, 40, 11, 888, DateTimeKind.Local).AddTicks(8969),
                            Name = "CV1202",
                            PageContent = ""
                        });
                });
            ...
            modelBuilder.Entity("POS.Models.Message", b =>
                {
                    ...
                    b.HasOne("POS.Models.NotificationItemMethod", "NotificationItemMethod")
                        .WithMany()
                        .HasForeignKey("NotificationItemMethodId");
                });
