...
class LandingPage extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{ flexGrow: '1', position: "relative", backgroundImage: `url(${imageBackgroundTop})`,backgroundPosition:'center',backgroundSize:'cover', backgroundRepeat:'no-repeat' ,height:'100vh' }}>
                {/*hero section*/}

                <Grid container>
                    <Grid item lg={12} md={12} sm={12} xs={12} style={{ height: '70vh' }} >
                        <Grid container direction="row" justify="center" alignItems="center" alignContent="center" style={{height: "50vh"}} >
                            <Grid item >
                                <h4>High-Privacy</h4>
